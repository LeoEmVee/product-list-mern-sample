...
const Loading = () => { // Función que retorna el componente que luego será renderizado.
  return ( // Contenido del componente que se retorna.
    <div className="columns is-centered">
      <Loader style={{width: 200, heigth: 200}}>TEXTOPARAQUESEMEVEALOADING</Loader>
    </div>
    
  )
}

export default Loading; // Exporta Loading, que será llamado en ProductLayout, componente padre de este.